...
<br>
ダミーのSMTPサーバなので実際にメールは送信はされない。<br>
そのため、メール送信サービスや、送信プログラム、スクリプトを作成した際のテストで使用する事ができる。<br>
また、送信結果をUIで確認出来る点も便利。<br><br>
なお、ローカルでメールを送受信できる環境については別プロジェクト(myMailServer)で構築したい考え。
